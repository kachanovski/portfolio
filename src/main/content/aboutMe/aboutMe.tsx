                    ...
                    <div className={style.aboutMe_wrap}>
                        ...
                        <div className={style.aboutMeContainer}>
                            <div className={style.aboutMeText}>
                                ...
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci illum inventore
                                laboriosam
                                necessitatibus nulla reiciendis sit. Assumenda atque culpa debitis delectus, ea, earum ipsa,
                                labore
